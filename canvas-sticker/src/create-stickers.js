...
export const Img = ({crossOrigin, onload, onerror, ...properties}) => Object.assign(createElement('img', {crossOrigin, onload, onerror}), properties);
const Button = properties => createElement('button', properties);
const Canvas = properties => createElement('canvas', properties);
export const createCanvas = properties => {
...
// const [canvas, ctx] = createCanvas({width: 800, height: 650, 
//   style: 'background: url(https://picsum.photos/300/200) no-repeat center / cover;'
// });
...
class Sticker {
  constructor(img, {left = 0, top = 0, defaultWidth = 100, maxWidth = 900, minWidth = 50} = {}) {
    const init = () => {
      Object.assign(this, {
        img, 
        left, 
...
export default function createStickers(canvas) {
  ...
  // const img1 = Img({src: 'https://picsum.photos/300/200?1', crossOrigin: 'anonymous'});
  // const img2 = Img({src: 'https://picsum.photos/300/200?2', crossOrigin: 'anonymous'});
  const img1 = Img({src: 'https://hashsnap-static.s3.ap-northeast-2.amazonaws.com/kiosk/201112_hello_museum/test1.png', crossOrigin: 'anonymous'});
  const img2 = Img({src: 'https://hashsnap-static.s3.ap-northeast-2.amazonaws.com/kiosk/201112_hello_museum/sticker8.png', crossOrigin: 'anonymous'});
  const img3 = Img({src: 'https://hashsnap-static.s3.ap-northeast-2.amazonaws.com/kiosk/201112_hello_museum/sticker5.png', crossOrigin: 'anonymous'});

  const sticker = new Sticker(img1, {left: canvas.width / 2, top: canvas.height / 2, defaultWidth: 100});
  const sticker2 = new Sticker(img2, {left: canvas.width / 2, top: canvas.height / 2, defaultWidth: 150});
  const sticker3 = new Sticker(img3, {left: canvas.width / 2, top: canvas.height / 2, defaultWidth: 150});
